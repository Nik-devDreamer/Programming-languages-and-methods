            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    if (InputData == 1)
                    {
                        ...
                        {
                            figure = new Rectangle(rnd.Next(1, 4), rnd.Next(1, 4), i + 1);
                            figures.Add(figure);
                        }
                    }
                    else if (InputData == 2)
                    {
                        for (int i = 0; i < countFigure; i++)
                        {
                            figure = new Ellipse(rnd.Next(1, 4), rnd.Next(1, 4), i + 1);
                            figures.Add(figure);
                        }
                    }
                    else if (InputData == 3)
                    {
                        for (int i = 0; i < countFigure; i++)
                        {
                            figure = new Triangle(rnd.Next(1, 4), rnd.Next(1, 4), rnd.Next(1, 4), i + 1);
                            figures.Add(figure);
                        }
                    }
                    else
